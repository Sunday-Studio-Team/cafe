...
var chance_of_machine_breaking_at_shift_end_each_day: Dictionary[int, float] = { 1: 0.15, 2: 0.16, 3: 0.17, 4: 0.18, 5: 0.20, 0: 0.0 }
...
var chance_of_machine_spill_at_shift_end_each_day: Dictionary[int, float] = { 1: 0.15, 2: 0.16, 3: 0.17, 4: 0.18, 5: 0.20, 0: 0.0 }
var machine_time_to_make_drink := 4.0
var customer_wait_time_machine := 35.0
var customer_wait_time_window := 25.0
var daily_profit_goals_each_day: Dictionary[int, float] = { 1: 25.0, 2: 35.0, 3: 40.0, 4: 50.0, 5: 60.0, 0: 100.0 }
