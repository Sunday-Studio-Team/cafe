...
func _ready() -> void:
	...
	#Call the appropriate tippy tutorial instruction function for the appropriate day
	#Look to lines 448 to 487 to see how to implement voice line logic (play the voice line and repeating)
	if Global.day == 0:
